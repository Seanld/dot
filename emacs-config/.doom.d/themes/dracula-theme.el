...
(def-doom-theme doom-dracula
  ...
  (((line-number &override) :foreground base5)
   ...
   ;;;; org <built-in>
   (org-title :height 38)
   (org-level-1 :inherit 'outline-1 :height 32)
   (org-level-2 :inherit 'outline-2 :height 28)
   (org-level-3 :inherit 'outline-3 :height 24)
   (org-level-4 :inherit 'outline-4 :height 20)
   (org-level-5 :inherit 'outline-5 :height 18)
   (org-level-6 :inherit 'outline-6 :height 16)
   (org-level-7 :inherit 'outline-7 :height 14)
   (org-level-8 :inherit 'outline-8 :height 14)
