...
(def-doom-theme doom-dracula-custom
  ...
  ((bg         '("#282a36" "#262626" "black"        ))
   ...
   (level5 (if doom-dracula-custom-colorful-headers cyan    (doom-lighten violet 0.6)))
   ...
   (level9 (if doom-dracula-custom-colorful-headers violet  (doom-lighten violet 0.95)))
   ...
   (modeline-bg-l `(,(doom-darken (car bg) 0.15) ,@(cdr base0)))
