...
-- theme.tasklist_fg_normal                        = "#ababab"
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup("#ffb86c", " " .. string.format("%05.1f", net_now.received))
                          .. " " ..
                          markup("#ff79c6", " " .. string.format("%05.1f", net_now.sent) .. " ")))
    end
})
...
local arrl_ld_start = separators.arrow_left(theme.bg_focus, theme.bg_focus)
